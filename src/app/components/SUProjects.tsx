      ...
      <div className="mt-10">
        ...
        <div className="space-y-2">
          ...
          <Select
            isMulti
            options={members.map(member => ({ value: member.id, label: `${member.firstName} ${member.lastName}` }))}
            value={newProject.members?.map(member => ({
              value: member.id,
              label: `${member.firstName} ${member.lastName}`
            }))}
