...
const Menu = () => (
    <div className="bg-white/10 col-span-3 rounded-lg p-4">
        ...
        <p className="text-slate-400 text-sm mb-2">Welcome back, User</p>

        {/* Heading Where the Profile Pic, Name and Position is */}
        <a href="/UserDashboard/profile" className="flex flex-col space-y-2 md:space-y-0 md:flex-row mb-5 items-center md:space-x-2 hover:bg-white/10 group transition duration-150 ease-linear rounded-lg group w-full py-3 px-2">
            <div>
        ...
        {/* Dashboard */}
        <a href="/UserDashboard" className="flex flex-col space-y-2 md:space-y-0 md:flex-row mb-1 items-center md:space-x-2 hover:bg-white/10 group transition duration-150 ease-linear rounded-lg group w-full py-3 px-2">
        ...
        {/* Users */}
        <a href="/UserDashboard/users" className="flex flex-col space-y-2 md:space-y-0 md:flex-row mb-1 items-center md:space-x-2 hover:bg-white/10 group transition duration-150 ease-linear rounded-lg group w-full py-3 px-2">
            <div className='items-center'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6 group-hover:text-indigo-400">
            ...
            <div>
               ...
               {/* Ranking */}
        <a href="/UserDashboard/rank" className="flex flex-col space-y-2 md:space-y-0 md:flex-row mb-1 items-center md:space-x-2 hover:bg-white/10 group transition duration-150 ease-linear rounded-lg group w-full py-3 px-2">
            <div className='items-center'>
        ...
        {/* Group Projects */}
        <a href="/UserDashboard/projects" className="flex flex-col space-y-2 md:space-y-0 md:flex-row mb-1 items-center md:space-x-2 hover:bg-white/10 group transition duration-150 ease-linear rounded-lg group w-full py-3 px-2">
            <div className='items-center'>
