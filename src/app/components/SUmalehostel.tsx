...
const SUmalehostel = () => {
    ...
    const initialUsers = [
        { id: 1, name: 'Fat Spaghetti', hostel: 'Old Daniel', status: 'A121' },
        { id: 2, name: 'Space Dad', hostel: 'Old Daniel', status: 'A121' },
    ];
    ...
    return (
        <div className="bg-white/10 col-span-9 rounded-lg p-6">
            <h1 className="font-bold py-4 uppercase">SU Male Hostel List</h1>
