const AdminStatistics = () => (
    <div className="bg-white/10 col-span-9 rounded-lg p-6">
            ...
            <div id="stats" className="grid gird-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="bg-black/60 to-white/5 p-6 rounded-lg">
                    ...
                    <div className="flex flex-row space-x-4 items-center">
                        ...
                        <div>
                            <p className="text-indigo-300 text-sm font-medium uppercase leading-4">members</p>
                ...
                <div className="bg-black/60 p-6 rounded-lg">
                    <div className="flex flex-row space-x-4 items-center">
                        <div id="stats-1">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="w-10 h-10 bi bi-database" viewBox="0 0 16 16">
                        ...
                        <div>
                            <p className="text-teal-300 text-sm font-medium uppercase leading-4">Data Collected</p>
                            <p className="text-white font-bold text-2xl inline-flex items-center space-x-2">
                                <span>+0</span>
                                <span>
                ...
                <div className="bg-black/60 p-6 rounded-lg">
                    <div className="flex flex-row space-x-4 items-center">
                        ...
                        <div>
                            <p className="text-blue-300 text-sm font-medium uppercase leading-4">My Current Point</p>
                            <p className="text-white font-bold text-2xl inline-flex items-center space-x-2">
                                <span>-29</span>
                                <span>
        ...
        <div id="current">
            ...
            <div id="stats" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                ...
                <div className="bg-black/60 to-white/5 rounded-lg">
                    <div className="flex flex-row items-center">
                        <div className="text-3xl p-4">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="w-10 h-10 bi bi-plug" viewBox="0 0 16 16">
                        ...
                        <div className="p-2">
                            <p className="text-xl font-bold">Networking</p>
                            <p className="text-gray-500 font-medium">Group</p>
                            <p className="text-gray-500 text-sm">3 Members</p>
                        </div>
                    </div>
                    <div className="border-t border-white/5 p-4">
                        <a href="/AdminDashboard/group" className="inline-flex space-x-2 items-center text-center">
                ...
                <div className="bg-black/60 to-white/5 rounded-lg">
                    <div className="flex flex-row items-center">
                        <div className="text-3xl p-4">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="w-10 h-10 bi bi-code-slash" viewBox="0 0 16 16">
                                <path d="M10.478 1.647a.5.5 0 1 0-.956-.294l-4 13a.5.5 0 0 0 .956.294zM4.854 4.146a.5.5 0 0 1 0 .708L1.707 8l3.147 3.146a.5.5 0 0 1-.708.708l-3.5-3.5a.5.5 0 0 1 0-.708l3.5-3.5a.5.5 0 0 1 .708 0m6.292 0a.5.5 0 0 0 0 .708L14.293 8l-3.147 3.146a.5.5 0 0 0 .708.708l3.5-3.5a.5.5 0 0 0 0-.708l-3.5-3.5a.5.5 0 0 0-.708 0" />
                            </svg>
                        </div>
                        <div className="p-2">
                            <p className="text-xl font-bold">Software</p>
                            <p className="text-gray-500 font-medium">Group</p>
                            <p className="text-gray-500 text-sm">14 Members</p>
                        </div>
                    </div>
                    <div className="border-t border-white/5 p-4">
                        <a href="/AdminDashboard/group" className="inline-flex space-x-2 items-center text-center">
                ...
                <div className="bg-black/60 to-white/5 rounded-lg">
                    <div className="flex flex-row items-center">
                        ...
                        <div className="p-2">
                            ...
                            <p className="text-gray-500 font-medium">Group</p>
                            <p className="text-gray-500 text-sm">2 Members</p>
                        </div>
                    </div>
                    <div className="border-t border-white/5 p-4">
                        <a href="/AdminDashboard/group" className="inline-flex space-x-2 items-center text-center">
                ...
                <div className="bg-black/60 to-white/5 rounded-lg">
                    <div className="flex flex-row items-center">
                        <div className="text-3xl p-4">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="w-10 h-10 bi bi-brush" viewBox="0 0 16 16">
                ...
                <div className="bg-black/60 to-white/5 rounded-lg">
                    <div className="flex flex-row items-center">
                        <div className="text-3xl p-4">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="w-10 h-10 bi bi-cpu" viewBox="0 0 16 16">
                ...
                <div className="bg-black/60 to-white/5 rounded-lg">
                    <div className="flex flex-row items-center">
                        <div className="text-3xl p-4">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="w-10 h-10 bi bi-shield-check" viewBox="0 0 16 16">
                        ...
                        <div className="p-2">
                            <p className="text-xl font-bold">Cyber Sec.</p>
                            <p className="text-gray-500 font-medium">Group</p>
                            <p className="text-gray-500 text-sm">1 Member</p>
                        </div>
                    </div>
                    <div className="border-t border-white/5 p-4">
                        <a href="#" className="inline-flex space-x-2 items-center text-center">
                ...
                <div className="bg-black/60 to-white/5 rounded-lg">
                    <div className="flex flex-row items-center">
                        <div className="text-3xl p-4">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className=" w-10 h-10 bi bi-robot" viewBox="0 0 16 16">
        ...
        {/* Most Ranked Section */}
        <div id="Rank">
            <h1 className="font-bold py-4 uppercase">Most ranked</h1>
