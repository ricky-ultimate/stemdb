...
const ManageUsersAdmin = () => {
        ...
        {editingId === user.id ? (
          <>
            ...
            <td className="py-3 px-2">
              <input
                className="bg-white/5 rounded-md text-white w-20"
                value={editUser.matric}
                onChange={(e) => handleInputChange(e, "matric")}
              />
            </td>
            <td className="py-3 px-2">
              <input
            ...
            <td className="py-3 px-2 text-right">
              <button onClick={() => saveRow(user.id)} className="px-2 py-1">
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  className="hover:text-green-500 w-5 h-5 bi bi-floppy"
                  viewBox="0 0 16 16"
                >
                  <path d="M11 2H9v3h2z" />
            ...
            <td className="py-3 px-2 text-right">
              ...
              <button onClick={() => deleteRow(user.id)} className="px-2 py-1">
                <svg
                  ...
                  height="16"
                  fill="currentColor"
                  className="w-5 h-5 bi bi-trash hover:text-red-600"
                  viewBox="0 0 16 16"
                >
  ...
  return (
    <div className="bg-white/10 col-span-9 rounded-lg p-6">
      ...
      <div className="overflow-x-auto overflow-y-auto max-h-52">
        <table className="w-full whitespace-nowrap">
          ...
          <thead className="bg-black/60 text-white">
            <tr>
              <th className="text-left py-3 px-2 rounded-l-lg" scope="col">
                Name
              </th>
              ...
              <th className="text-right py-3 px-2 rounded-r-lg" scope="col">
                Actions
              </th>
            </tr>
          </thead>
      ...
      <div className="mt-4">
        <input
          className="bg-white/5 rounded-md text-white w-30 mr-2"
          value={editUser.name}
          onChange={(e) => handleInputChange(e, "name")}
          placeholder="Name"
        />
        ...
        <input
          className="bg-white/5 rounded-md text-white  w-20 mr-2"
          value={editUser.department}
          onChange={(e) => handleInputChange(e, "delartment")}
                ...
                <tr key={task.id} className="border-b border-gray-700">
                  ...
                  <td className="py-3 px-2 text-right">
                    {editingTask === task.id ? (
                      ...
                      <span className={task.matric}>{task.matric}</span>
                    )}
                  </td>
                  <td className="py-3 px-2 text-right">
